...
local c = require('my_vivid.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "SpellBad", { fg = 'NONE', bg = 'NONE', sp = c.vivid_red, undercurl=true, })
  hl(0, "SpellCap", { fg = 'NONE', bg = 'NONE', sp = c.yellow, undercurl=true, })
  hl(0, "SpellLocal", { fg = 'NONE', bg = 'NONE', sp = c.green, underline=true, })
  hl(0, "SpellRare", { fg = 'NONE', bg = 'NONE', sp = c.vivid_purple, underline=true, })
  hl(0, "NormalNC", { fg = c.fg, bg = c.bg })
  hl(0, "Pmenu", { fg = c.light_gray, bg = c.menu_bg })
  hl(0, "PmenuSel", { fg = 'NONE', bg = c.ui2_blue })
  hl(0, "WildMenu", { fg = c.vivid_fg_delimiter, bg = c.ui2_blue })
  hl(0, "CursorLineNr", { fg = c.vivid_yellow2, bg = 'NONE' })
  ...
  hl(0, "Visual", { fg = 'NONE', bg = c.ui6_blue })
  ...
  hl(0, "DiffChange", { fg = c.alt_bg, bg = c.sign_change })
  ...
  hl(0, "TabLineSel", { fg = c.vivid_fg_delimiter, bg = c.line })
  hl(0, "TabLineFill", { fg = c.line, bg = c.line })

  -- Code
  hl(0, "Comment", { fg = c.context, bg = 'NONE' })
  hl(0, "Variable", { fg = c.light_blue, bg = 'NONE' })
  hl(0, "String", { fg = c.vivid_green, bg = 'NONE' })
  hl(0, "Character", { fg = c.vivid_red, bg = 'NONE' })
  hl(0, "Number", { fg = c.vivid_yellow, bg = 'NONE' })
  hl(0, "Float", { fg = c.vivid_yellow, bg = 'NONE' })
  hl(0, "Boolean", { fg = c.vivid_orange, bg = 'NONE' })
  hl(0, "Constant", { fg = c.vivid_yellow, bg = 'NONE' })
  hl(0, "Type", { fg = c.vivid_orange, bg = 'NONE' })
  hl(0, "Function", { fg = c.vivid_red, bg = 'NONE' })
  hl(0, "Keyword", { fg = c.vivid_purple, bg = 'NONE' })
  hl(0, "Conditional", { fg = c.vivid_purple, bg = 'NONE' })
  hl(0, "Repeat", { fg = c.vivid_purple, bg = 'NONE' })
  hl(0, "Operator", { fg = c.vivid_grey, bg = 'NONE' })
  hl(0, "PreProc", { fg = c.vivid_purple, bg = 'NONE' })
  hl(0, "Include", { fg = c.vivid_purple, bg = 'NONE' })
  hl(0, "Exception", { fg = c.vivid_purple, bg = 'NONE' })
  hl(0, "StorageClass", { fg = c.vivid_white, bg = 'NONE' })
  hl(0, "Structure", { fg = c.vivid_white, bg = 'NONE' })
  hl(0, "Typedef", { fg = c.vivid_purple, bg = 'NONE' })
  hl(0, "Define", { fg = c.vivid_purple, bg = 'NONE' })
  hl(0, "Macro", { fg = c.vivid_orange, bg = 'NONE' })
  hl(0, "Debug", { fg = c.vivid_red, bg = 'NONE' })
  hl(0, "Title", { fg = c.vivid_orange, bg = 'NONE', bold=true, })
  hl(0, "Label", { fg = c.vivid_orange, bg = 'NONE' })
  hl(0, "SpecialChar", { fg = c.vivid_orange, bg = 'NONE' })
  hl(0, "Delimiter", { fg = c.vivid_fg_delimiter, bg = 'NONE' })
  hl(0, "SpecialComment", { fg = c.vivid_fg_delimiter, bg = 'NONE' })
  hl(0, "Tag", { fg = c.vivid_orange, bg = 'NONE' })
  ...
  hl(0, "Statement", { fg = c.vivid_purple, bg = 'NONE' })
  hl(0, "Identifier", { fg = c.fg, bg = 'NONE' })
  hl(0, "PreCondit", { fg = c.vivid_purple, bg = 'NONE' })
  hl(0, "Special", { fg = c.vivid_orange, bg = 'NONE' })

  -- Treesitter
  hl(0, "TSComment", { fg = c.context, bg = 'NONE', italic=true, })
  ...
  hl(0, "TSEnvironmentName", { fg = c.vivid_white, bg = 'NONE' })
  hl(0, "TSVariableBuiltin", { fg = c.vivid_white, bg = 'NONE' })
  hl(0, "TSConstMacro", { fg = c.vivid_blue, bg = 'NONE' })
  hl(0, "TSTypeBuiltin", { fg = c.vivid_white, bg = 'NONE' })
  hl(0, "TSAnnotation", { fg = c.vivid_orange, bg = 'NONE' })
  hl(0, "TSNamespace", { fg = c.vivid_white, bg = 'NONE' })
  ...
  hl(0, "TSAttribute", { fg = c.vivid_white, bg = 'NONE' })
  ...
  hl(0, "TSURI", { fg = c.vivid_white, bg = 'NONE', underline=true, })
  hl(0, "TSMath", { fg = c.yellow, bg = 'NONE' })
  hl(0, "TSLiteral", { fg = c.vivid_red, bg = 'NONE' })
  ...
  hl(0, "markdownOrderedListMarker", { fg = c.vivid_purple, bg = 'NONE' })
  ...
  -- Whichkey
  hl(0, "WhichKey", { fg = c.vivid_purple, bg = 'NONE' })
  ...
  hl(0, "TelescopeSelectionCaret", { fg = c.vivid_red, bg = c.ui2_blue })
  ...
  hl(0, "TelescopePromptCounter", { fg = c.vivid_red, bg = 'NONE' })
  hl(0, "TelescopePreviewHyphen", { fg = c.vivid_red, bg = 'NONE' })
  ...
  hl(0, "BufferCurrentTarget", { fg = c.vivid_red, bg = c.bg, bold=true, })
  ...
  hl(0, "BufferVisibleTarget", { fg = c.vivid_red, bg = c.bg, bold=true, })
  ...
  hl(0, "BufferInactiveTarget", { fg = c.vivid_red, bg = c.alt_bg, bold=true, })
  ...
  hl(0, "DashboardCenter", { fg = c.vivid_purple, bg = 'NONE' })
  ...
  hl(0, "diffOldFile", { fg = c.vivid_red, bg = 'NONE' })
  hl(0, "debugPc", { fg = 'NONE', bg = c.ui5_blue })
  hl(0, "debugBreakpoint", { fg = c.vivid_red, bg = 'NONE', reverse=true, })
  ...
  hl(0, "cssInclude", { fg = c.vivid_purple, bg = 'NONE' })
  ...
  hl(0, "cssFunction", { fg = c.vivid_purple, bg = 'NONE' })
